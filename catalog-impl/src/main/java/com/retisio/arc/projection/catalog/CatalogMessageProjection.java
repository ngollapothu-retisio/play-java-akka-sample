...
@Slf4j
public class CatalogMessageProjection {
    ...
    private static Projection<EventEnvelope<CatalogEvent>> createProjection(ActorSystem<?> system,
        ...
        log.info("CatalogMessageProjection init()..................");
        return R2dbcProjection.atLeastOnce(
                        projectionId, settings, sourceProvider, () -> new CatalogMessageProjectionHandler(ClusterSharding.get(system), topic, kafkaUtil), system)
